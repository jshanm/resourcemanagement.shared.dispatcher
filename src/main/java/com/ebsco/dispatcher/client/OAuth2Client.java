...
public class OAuth2Client implements ClientDetails {
    ...
    public Set<String> getResourceIds() {
        return new HashSet<String>(this.client.getResourceIds());
    }
    ...
    public Set<String> getScope() {
        return new HashSet<String>(this.client.getScope());
    }

    @Override
    public Set<String> getAuthorizedGrantTypes() {
        return new HashSet<String>(this.client.getAuthorizedGrantTypes());
    }

    @Override
    public Set<String> getRegisteredRedirectUri() {
        return new HashSet<String>(this.client.getRegisteredRedirectURI());
    }
